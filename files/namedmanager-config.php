...
*/
$config["db_host"] = "127.0.0.1";			    // hostname of the MySQL server
$config["db_name"] = "namedmanager";			// database name
$config["db_user"] = "namedmanager";			// MySQL user
$config["db_pass"] = "@MYSQL_NM_PASSWORD@";		// MySQL password (if any)

$_SERVER['HTTPS'] = "TRUE"; // do not force HTTPS, it's webserver's job, not PHP's
